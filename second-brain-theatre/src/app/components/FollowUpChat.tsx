...
const HARDCODED_REPLIES: Record<string, string> = {
  firefighter:   "I hear you, but can we at least do the one urgent thing? Just the one. Then we can breathe.",
  alien:         "Golrp... your human logic is confusing me again. But maybe that confusion is actually useful here?",
  astronaut:     "Copy that. From up here, I can see this is temporary. It always passes. Roger that.",
  chef:          "Oui oui. Let's gather the ingredients first before we even think about turning on the heat.",
  director:      "CUT! Let's take that from the top. What's the scene we actually want to be shooting here?",
  doctor:        "Mmhm. And how long has this been going on? I need more history before I can prescribe anything.",
  hazmat:        "*ksshh* Understood. Initiating decon protocol. First we identify the source of contamination.",
  judge:         "Sustained. The court has heard enough. Here's my ruling on what needs to happen next.",
  nerd:          "Umm, actually — have we looked at all the data here? Let me pull up what I know about this.",
  referee:       "*TWEEEEET!* That's a foul. Let's review the tape on what just happened here.",
  soccer_player: "Pass the ball! You don't have to score this one alone — who's open on the field?",
  spy:           "Intel received. But what aren't you telling me? There's more going on here than the surface shows.",
  superhero:     "No one gets left behind. But even heroes need to triage. Who needs us most right now?",
  therapist:     "Mmhmm. I hear you. And underneath all of that... what are you actually feeling?",
  wizard:        "Ahhhh yes... I sense you're trying to solve this the hard way. There's a spell for this.",
}
